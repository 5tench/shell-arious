#!/bin/bash
# Post-installation script for Rocky Linux VM: Add user to wheel group and install XFCE GUI
...
echo "After reboot, log in as $USERNAME to use the XFCE GUI."
...
echo "Verify mouse cursor in XFCE; if issues persist, recheck Guest Additions."